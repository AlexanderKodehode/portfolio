...
const AboutMePage = () => {
    return (
        <>
            <p>Jeg heter Alexander og er 22 år, og for øyeblikket deltar jeg på kodehode IT AMO kurs. Her driver jeg å bygge opp kompetanse rundt html, css, javascript og python.Jeg ser mine sterkeste side som en person som er lærelysten, sosial og kunnskapssøkende.</p>
            <br/>
