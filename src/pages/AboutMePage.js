...
const AboutMePage = () => {
    return (
        <>
            <p className={styles.text}>Jeg heter Alexander og er 23 år, og for øyeblikket deltar jeg på kodehode IT AMO kurs. Her driver jeg å bygge opp kompetanse rundt html, css, javascript og react.Jeg ser mine sterkeste side som en person som er lærelysten, sosial og kunnskapssøkende.</p>
            <br/>
